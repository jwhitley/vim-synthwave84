...
" Last Updated: Wed Jul 22 17:42:11 2020
...
hi! link Error swErrorHi
hi! link ErrorMsg swError
...
hi! link CocErrorVirtualText swError
hi! link CocWarningVirtualText swWarning
hi! link CocInfoVirtualText swInfo
hi! link CocHintVirtualText swHint
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if has('nvim')
    ...
    let g:terminal_color_1 = 'DarkRed'
    let g:terminal_color_2 = 'DarkGreen'
    let g:terminal_color_3 = 'DarkYellow'
    let g:terminal_color_4 = 'DarkBlue'
    let g:terminal_color_5 = 'DarkMagenta'
    let g:terminal_color_6 = 'DarkCyan'
    let g:terminal_color_7 = 'LightGrey'
    let g:terminal_color_8 = 'DarkGrey'
    let g:terminal_color_9 = 'Red'
    let g:terminal_color_10 = 'Green'
    let g:terminal_color_11 = '#FEDE5D'
    let g:terminal_color_12 = 'Blue'
    let g:terminal_color_13 = '#D884C7'
  ...
  hi DiffAdd guifg=#90DEB6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=#D884C7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#EB8F82 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi DiffText guifg=Red guibg=NONE guisp=NONE gui=bold cterm=bold
  hi FoldColumn guifg=#7f87c4 guibg=#2C2540 guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#7f87c4 guibg=#2C2540 guisp=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#888690 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#7f87c4 guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi PmenuSel guifg=#ECEBED guibg=#7f87c4 guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#E7CB59 guibg=#393939 guisp=NONE gui=bold cterm=bold
  hi StatusLineNC guifg=#ECEBED guibg=#393939 guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#7f87c4 guibg=#2C2540 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Todo guifg=#E7CB59 guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
  hi VertSplit guifg=#2C2540 guibg=#7f87c4 guisp=NONE gui=reverse cterm=reverse
  ...
  hi Comment guifg=#7f87c4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Constant guifg=#E55A5E guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Error guifg=#ECEBED guibg=#E55A5E guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#ECEBED guibg=#B4353A guisp=NONE gui=NONE cterm=NONE
  ...
  hi Statement guifg=#FEDE5D guibg=NONE guisp=NONE gui=italic cterm=italic
  ...
  hi swErrorHi guifg=#ECEBED guibg=#E55A5E guisp=NONE gui=NONE cterm=NONE
  hi swError guifg=#ECEBED guibg=#B4353A guisp=NONE gui=NONE cterm=NONE
  hi swWarning guifg=#EA9652 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi swInfo guifg=#888690 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi swHint guifg=#90DEB6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi gitcommitSelectedType guifg=#AFB3DA guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi gitcommitSelectedFile guifg=#90DEB6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi gitcommitUntrackedFile guifg=#E55A5E guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CocUnderline guifg=NONE guibg=NONE guisp=#ECEBED gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocErrorHighlight guifg=NONE guibg=NONE guisp=Red gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocWarningHighlight guifg=NONE guibg=NONE guisp=#EA9652 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocInfoHighlight guifg=NONE guibg=NONE guisp=#D4D3D7 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocHintHighlight guifg=NONE guibg=NONE guisp=#90DEB6 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocCodeLens guifg=#888690 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CocCursorRange guifg=#2C2540 guibg=#DFC024 guisp=NONE gui=underline cterm=underline
  if !s:italics
...
if s:t_Co >= 256
  ...
  hi DiffAdd ctermfg=121 ctermbg=NONE cterm=NONE
  hi DiffChange ctermfg=13 ctermbg=NONE cterm=NONE
  hi DiffDelete ctermfg=224 ctermbg=NONE cterm=NONE
  hi DiffText ctermfg=9 ctermbg=NONE cterm=bold
  ...
  hi StatusLine ctermfg=11 ctermbg=8 cterm=bold
  ...
  hi Statement ctermfg=11 ctermbg=NONE cterm=italic
  ...
  hi swErrorHi ctermfg=7 ctermbg=9 cterm=NONE
  hi swError ctermfg=7 ctermbg=9 cterm=NONE
  hi swWarning ctermfg=224 ctermbg=NONE cterm=NONE
  hi swInfo ctermfg=7 ctermbg=NONE cterm=NONE
  hi swHint ctermfg=121 ctermbg=NONE cterm=NONE
  hi rubySymbol ctermfg=224 ctermbg=NONE cterm=NONE
  hi rubyBoolean ctermfg=224 ctermbg=NONE cterm=NONE
  hi gitcommitSelectedType ctermfg=14 ctermbg=NONE cterm=NONE
  hi gitcommitSelectedFile ctermfg=121 ctermbg=NONE cterm=NONE
  hi gitcommitUntrackedFile ctermfg=9 ctermbg=NONE cterm=NONE
  hi CocUnderline ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocErrorHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocWarningHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocInfoHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocHintHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocCodeLens ctermfg=7 ctermbg=NONE cterm=NONE
  hi CocCursorRange ctermfg=7 ctermbg=11 cterm=underline
  if !s:italics
...
if s:t_Co >= 8
  ...
  hi DiffChange ctermfg=Magenta ctermbg=NONE cterm=NONE
  ...
  hi StatusLine ctermfg=Yellow ctermbg=DarkGray cterm=bold
  ...
  hi Todo ctermfg=Yellow ctermbg=NONE cterm=bold,underline
  ...
  hi ErrorMsg ctermfg=LightGray ctermbg=Red cterm=NONE
  ...
  hi Statement ctermfg=Yellow ctermbg=NONE cterm=italic
  ...
  hi swErrorHi ctermfg=LightGray ctermbg=Red cterm=NONE
  hi swError ctermfg=LightGray ctermbg=Red cterm=NONE
  hi swWarning ctermfg=LightRed ctermbg=NONE cterm=NONE
  hi swInfo ctermfg=LightGray ctermbg=NONE cterm=NONE
  hi swHint ctermfg=LightGreen ctermbg=NONE cterm=NONE
  hi rubySymbol ctermfg=LightRed ctermbg=NONE cterm=NONE
  hi rubyBoolean ctermfg=LightRed ctermbg=NONE cterm=NONE
  hi gitcommitSelectedType ctermfg=Cyan ctermbg=NONE cterm=NONE
  hi gitcommitSelectedFile ctermfg=LightGreen ctermbg=NONE cterm=NONE
  hi gitcommitUntrackedFile ctermfg=Red ctermbg=NONE cterm=NONE
  hi CocUnderline ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocErrorHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocWarningHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  hi CocInfoHighlight ctermfg=NONE ctermbg=NONE cterm=undercurl
  ...
  hi CocCursorRange ctermfg=LightGray ctermbg=Yellow cterm=underline
  if !s:italics
    hi Statement cterm=NONE
  endif
  unlet s:t_Co s:italics
...
" Color: s_eightiesgray       #393939                8        DarkGray
...
" Color: s_yellow70           #DFC024                11       Yellow
" Color: s_yellow90           #E7CB59                11       Yellow
" Color: s_yellow100          #FEDE5D                11       Yellow
" Color: s_governorbay100     #7f87c4                14       Cyan
" Color: s_governorbay120     #AFB3DA                14       Cyan
" Color: s_grape              #3E3B4B                8        DarkGray
" Color: s_red100             #E55A5E                9        Red
" Color: s_red70              #B4353A                9        Red
...
" Term Colors: darkgrey red green s_yellow100 blue s_magenta cyan white
" Background: dark
" vim: et ts=2 sw=2
